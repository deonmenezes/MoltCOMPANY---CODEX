    ...
    <div className="page-shell pt-24 pb-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-sm text-brand-gray-medium mb-6 font-display">
          ...
          <span className="text-brand-gray-dark font-bold">Tutorials</span>
        </div>

        <h1 className="comic-heading text-4xl mb-2 text-white">TUTORIALS</h1>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {tutorials.map((tutorial) => (
            <Link key={tutorial.title} href={tutorial.href} className="comic-card p-6 no-underline hover:-translate-y-0.5 transition-transform">
              <div className="flex items-center gap-3 mb-4">
                <TaskMiniMark color={tutorial.color} />
                <h2 className="comic-heading text-2xl text-white">{tutorial.title}</h2>
              </div>
